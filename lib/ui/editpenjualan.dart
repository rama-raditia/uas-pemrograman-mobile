...
class EditPenjualan extends StatelessWidget {
 ...
 Future updateData() async {
    final response = await http.put(
        Uri.parse("http://192.168.43.104:80/api/products/" + input['id'].toString()),
        body: {
          "Namabarang": nameController.text,
          "Namapembeli": deskripsiController.text,
          ...
          child: ListView(
            children: <Widget>[
              Padding(
                ...
                child: TextFormField(
                  controller: nameController..text = input['Nama barang'],
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return "Nama Barang Yang Akan Dibeli Harus Diisi!!";
                    }
                    return null;
                  },
                ),
